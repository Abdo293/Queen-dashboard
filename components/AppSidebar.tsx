...
export function AppSidebar({
  ...
  const items = [
    ...
    { title: t("categories"), url: "/dashboard/categories", icon: Layers },
    { title: t("types"), url: "/dashboard/product-types", icon: Tag },
    { title: t("products"), url: "/dashboard/products", icon: Package },
    { title: t("offers"), url: "/dashboard/offers", icon: Gift },
    { title: t("coupons"), url: "/dashboard/coupons", icon: TicketPercent },
    { title: t("orders"), url: "/dashboard/orders", icon: Receipt },
  ];
      ...
      >
        <SidebarHeader>
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            {isExpanded && <span className="font-semibold">Queen</span>}
          </Link>
        </SidebarHeader>
        <SidebarContent>
          <SidebarGroup>
